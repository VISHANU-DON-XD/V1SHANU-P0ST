...
[> Note :: ALL HATERS YOUR MAA CHOD KR DFN KARNI WALII MACHINE<]
    """
...
def main():
    print("\033[1;36m(VISHANU DON KING HERW )Start Time:", time.strftime("%Y-%m-%d %H:%M:%S"))
    ...
    while True:
        try:
            ...
            lines()
            delay = int(input("\033[1;36m[[=>]] ENTER YOUR TIME HERE : "))
            lines()
